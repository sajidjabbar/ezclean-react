                                ...
                                <form className="mt-5">
                                    <div className="row">
                                        <div className="col-md-6 ml-auto mr-auto">
                                            ...
                                            <div className="col-md-12 mt-3">
                                                <input className="form-control" type="text" placeholder="Add Referral Code"/>
                                            </div>
                                            <button className="btn btn-primary ez-clean-btn-rounded mt-3 justify-content-center ml-auto mr-auto d-flex" href="javascript:void(0);">Signup</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
