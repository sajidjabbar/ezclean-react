                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <p className="about-text">We believe cleaning should be a luxury every family can afford. For the last two
                                    ...
                                    .</p>
                                <a className="btn btn-primary ez-clean-btn-rounded mt-3" href="javascript:void(0);">Learn More</a>
                            </div>
                            <div className="col-md-6">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 d-flex align-items-stretch">
                                <div className="service-card d-flex flex-column w-100">
                                    ...
                                    <a className="btn btn-primary ez-clean-btn-rounded mt-auto w-50 ml-auto mr-auto" href="javascript:void(0);">Book Now</a>
                                </div>
                            </div>
                            <div className="col-md-4 d-flex align-items-stretch">
                                <div className="service-card d-flex flex-column w-100">
